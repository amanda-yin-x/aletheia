...
specific pre-release job: customer-agent teams maintain long instruction bundles
that mix style, workflow, knowledge, runtime facts, and hard constraints. A
founder described reducing one roughly 400-line file to roughly 50 lines and
reported better quality and cost. That is one strong signal, not market
validation or proof of willingness to pay.
