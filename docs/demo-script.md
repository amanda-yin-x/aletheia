...
**0:00–0:12 — Context.** Open Northstar Retail. “This fictional refund agent's
rules are spread across its baseline prompt, current policy, and stale SOP.”
...
the arms start from identical fixture hashes.
...
**1:25–1:30 — Evidence.** Create the report. Point to scope, fixture provenance,
build/run/dataset hashes, three-arm metrics, limitations, and Markdown/JSON
exports. Say “ready for sandbox pilot,” never “safe” or “certified.”
