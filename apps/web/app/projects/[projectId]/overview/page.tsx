...
export default function OverviewPage() {
  ...
  return <div className="content-wrap">
    ...
    <section className="panel" style={{ marginBottom: 16 }}>
      <div className="panel-header"><div><h2>Release workflow</h2><p>Review gates are explicit; artifacts and results are immutable snapshots.</p></div></div>
      ...
      <section className="panel">
        ...
        <div className="panel-body">
          <ul className="activity-list">
            <li><FileText size={17} /><p><strong>Source corpus verified</strong><small> {data.sources} immutable documents</small></p><Badge tone="teal">Complete</Badge></li>
            ...
            <li><ShieldCheck size={17} /><p><strong>Candidate build</strong><small> {data.current_build ? shortHash(data.current_build.content_hash) : "Not built"}</small></p><Badge>{data.current_build ? "Immutable" : "Pending"}</Badge></li>
          </ul>
        </div>
      </section>
